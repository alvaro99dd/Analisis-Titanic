...
df_repaired = pd.read_csv(r"Recursos\titanic_repaired.csv")
...
def inicio():
    ...
    with col1:
        # Imagen
        st.markdown("##")
        st.image("Recursos\imagen_Titanic.webp"
...
def reparacion():
    ...
    st.image(r"Recursos\heatmap.png")
    st.divider()
...
def clase_pasajero():
    ...
    with col2:
        ...
        st.markdown("#####")
        # Muestro la imagen
        st.image(r"Recursos\clases_titanic.jpg", caption=["Menús de primera, segunda y tercera clase que se sirvieron el último día de navegación del Titanic. Créditos: rafaelcastillejo.com"])
